...
public class UpdateProjectCommand implements Command {
    ...
    public Router execute(HttpServletRequest request, HttpServletResponse response) throws CommandException, ServletException, IOException, ServiceException {
        Part projectIdPart = request.getPart("project_id");
        ...
        String projectIdAsString = new String(projectIdPart.getInputStream().readAllBytes());
        int projectId = Integer.parseInt(projectIdAsString);
